...
num7_to_num = {0b01110111: 0, 0b00010010: 1, 0b01011101: 2, 0b01011011: 3,
               0b00111010: 4, 0b01101011: 5, 0b01101111: 6, 0b01010010: 7,
               0b01111111: 8, 0b01111011: 9}
result = 0

with open("08/notes.txt") as notes:
    for line in notes:
        letter_to_num = {'a': 0, 'b': 0, 'c': 0, 'd': 0,
                         'e': 0, 'f': 0, 'g': 0}
        ...
        if unknown_letters == 2:
            for letter in words_per_length[5 - 2][0]:
                # since 2 and 1 have only 'ur' in common,
                # we can deduct 'ur' (now) and 'dr' (later)
            ...
            for letter in words_per_length[5 - 2][0]:
                ...
                elif not (letter_to_num[letter] == 16
                          or letter_to_num[letter] == 64):
                    # deducting 'md'
